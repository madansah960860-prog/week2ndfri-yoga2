...
<title>Nine Breaths | Free Pose Guides, Sequences and Breathwork for Beginners</title>
...
<link rel="canonical" href="https://www.ninebreaths.com/index.html">
<meta name="robots" content="index, follow, max-image-preview:large">
<meta name="theme-color" content="#F5F5F7">

<!-- Open Graph / social -->
<meta property="og:type" content="website">
<meta property="og:site_name" content="Nine Breaths">
<meta property="og:locale" content="en_US">
<meta property="og:title" content="Nine Breaths | Free Pose Guides, Sequences and Breathwork for Beginners">
...
<meta property="og:url" content="https://www.ninebreaths.com/index.html">
...
<meta name="twitter:title" content="Nine Breaths | Free Pose Guides, Sequences and Breathwork for Beginners">
...
<!-- Type: Bricolage Grotesque display, Public Sans body, JetBrains Mono for labels -->
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link rel="preconnect" href="https://images.unsplash.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,600;12..96,700&family=Public+Sans:ital,wght@0,400;0,500;0,600;1,400&family=JetBrains+Mono:wght@500;700&display=swap" rel="stylesheet">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://www.ninebreaths.com/#org",
      "name": "Nine Breaths",
      "url": "https://www.ninebreaths.com/",
      "email": "hello@ninebreaths.com",
      "telephone": "+1-828-555-0142",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "118 Rosewood Lane, Suite 2",
    ...
    {
      "@type": "WebSite",
      "@id": "https://www.ninebreaths.com/#website",
      "url": "https://www.ninebreaths.com/",
      "name": "Nine Breaths",
      "inLanguage": "en-US",
      "publisher": {
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.ninebreaths.com/index.html",
      "url": "https://www.ninebreaths.com/index.html",
      "name": "Nine Breaths",
      "isPartOf": {
        "@id": "https://www.ninebreaths.com/#website"
      }
...
<body>
  ...
  <header class="site-header">
    <div class="wrap header-inner">
      <a class="wordmark" href="index.html">Nine<span>Breaths</span></a>
  ...
  <main id="main">
    ...
    <section class="hero wrap">
      <div class="hero__grid">
        <div>
          ...
          <h1>Yoga you can actually follow.</h1>
    ...
    <!-- ==================== The site in four numbers ==================== -->
    <section class="section section--flush wrap reveal">
      <div class="stat-grid">
        <div class="stat"><span class="stat__num">38</span><span class="stat__label">Poses indexed</span></div>
        <div class="stat"><span class="stat__num">6</span><span class="stat__label">Full breakdown cards</span></div>
        <div class="stat"><span class="stat__num">4</span><span class="stat__label">Complete sequences</span></div>
        <div class="stat"><span class="stat__num">6</span><span class="stat__label">Styles explained</span></div>
      </div>
    </section>
    ...
    <section class="section wrap reveal" aria-labelledby="ways-in">
      <div class="measure measure--left section__head">
        <span class="section__index">01 / Three ways in</span>
      ...
      <ol class="steps measure measure--left">
        ...
        <li>
          <div>
            ...
            <p>Thirty-eight poses indexed by English and Sanskrit name, filterable by difficulty, by the part of the body that moves and by the prop required. Six of them carry a full breakdown card with entry steps, alignment cues, breath pattern, hold time, common mistakes, modifications and contraindications.</p>
          </div>
        </li>
        <li>
          <div>
    ...
    <section class="section section--tint reveal" aria-labelledby="featured-seq">
      <div class="wrap">
        <div class="split">
          ...
          <div>
            <span class="section__index">02 / Featured sequence</span>
    ...
    <section class="section wrap reveal" aria-labelledby="breakdown-demo">
      <div class="measure measure--left section__head">
        <span class="section__index">03 / Anatomy of a guide</span>
        <p class="eyebrow">Same card, every pose</p>
    ...
    <section class="section wrap reveal" aria-labelledby="styles-glance">
      <div class="measure measure--left section__head">
        <p class="eyebrow">Class names decoded</p>
    ...
    <section class="section section--ink reveal" aria-labelledby="funding">
      <div class="wrap measure measure--left">
        <p class="eyebrow">No paywall</p>
        ...
        <div class="btn-row">
          <a class="btn btn--olive" href="pricing.html">See what membership includes</a>
    ...
    <section class="section wrap reveal" aria-labelledby="nl-home">
      <div class="measure measure--left">
        ...
        <form class="form-stack" data-validate id="newsletter-home" novalidate
              data-success-message="You are on the list. Check your inbox for a confirmation email from Nine Breaths, sent from hello@ninebreaths.com.">
          <div class="field">
    ...
    <div class="wrap">
      <div class="footer-grid">
        ...
        <div class="footer-col footer-brand">
          ...
          <address>
            Nine Breaths<br>
            118 Rosewood Lane, Suite 2<br>
            Asheville, NC 28801<br>
            United States<br>
            <a href="tel:+18285550142">+1 (828) 555-0142</a><br>
            <a href="mailto:hello@ninebreaths.com">hello@ninebreaths.com</a>
          </address>
      ...
      <div class="footer-legal">
        <span>&copy; <span data-year>2026</span> Nine Breaths. All rights reserved.</span>
        ...
        <a href="contact.html">Contact Nine Breaths</a>
      </div>
    </div>
  </footer>
